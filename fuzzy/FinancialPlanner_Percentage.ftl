...
PROJECT {
  ...
  AUDIT { TIMESTAMP = 1476499125; NAME = Tin-Onn; LICENSE = FT 10006 26 HS; RELEASE = 8.30b; COMMENT {Last Edit} }
  AUDIT { TIMESTAMP = 1476500380; NAME = Tin-Onn; LICENSE = FT 10006 26 HS; RELEASE = 8.30b; COMMENT {Last Edit} }
  AUDIT { TIMESTAMP = 1476502816; NAME = Tin-Onn; LICENSE = FT 10006 26 HS; RELEASE = 8.30b; COMMENT {Last Edit} }
  SHELLOPTIONS {
    ONLINE_CODE = OFF;
  ...
  MODEL {
    VARIABLE_SECTION {
      ...
      LVAR {
        ...
        INPUT = CMBF;
        BASEVAR = Percentage;
        LVRANGE = MIN(0.0), MAX(100.0), MINDEF(0), MAXDEF(65535), DEFAULT(10.0);
        POS = -1461, -1092;
        TERM {
          TERMNAME = low;
          SHAPE = STANDARD;
